...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/home/xmli/hlyang/MRG/dataset/mimic_cxr/mimic_cxr/images/', help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/home/xmli/hlyang/MRG/PromptMRG/data/mimic_cxr/mimic_annotation_promptmrg.json', help='the path to the directory containing the data.')
    ...
    # Model settings 
    parser.add_argument('--load_pretrained', type=str, default='/home/xmli/hlyang/MRG/PromptMRG/results/promptmrg/model_promptmrg.pth', help='pretrained path if any')
    parser.add_argument('--load_sbd_pretrained', type=str, default='/home/xmli/hlyang/MRG/OS_RRG/checkpoints/sbd/sbd.pth', help='pretrained path if any')
    # Sample related
    ...
    parser.add_argument('--save_dir', type=str, default='/home/xmli/hlyang/MRG/PromptMRG/results/promptmrg', help='the patch to save the models.')
...
def main():
    ...
    test_dataset = create_dataset_test('generation_%s'%args.dataset_name, tokenizer, args, split='test')
    ...
    if args.load_sbd_pretrained:
        state_dict = torch.load(args.load_sbd_pretrained, map_location="cpu")
        model.sbd.load_state_dict(state_dict, strict=False)
        print("load checkpoint from {}".format(args.load_sbd_pretrained))
    ...
    log_test = tester.test_blip(split='test')
