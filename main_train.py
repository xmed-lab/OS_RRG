...
import argparse
import numpy as np
from modules.metrics import compute_scores, compute_bleu
# from modules.trainer import Trainer
from modules.trainer_wandb import Trainer
from modules.classifier import Classifier
from models.blip import blip_decoder
from modules.losses import DiverseExpertLoss
...
def parse_agrs():
    ...
    parser.add_argument('--monitor_metric', type=str, default='ce_f1_class', help='the metric to be monitored.')
    ...
    # mode
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'SBD'], help='the mode of the model.')
    # start_epoch
    parser.add_argument('--start_epoch', type=int, default=0, help='the start epoch of the model.')
...
def main():
    ...
    base_probs = np.load('/home/xmli/hl_yang/TOG_RRG/data/mimic_cxr/base_probs.npy')
    print(base_probs.tolist())
    ...
    criterion_cls = DiverseExpertLoss()
